...
function (module, exports, __webpack_require__) {
  ...
  var Request = function () {
    ...
    Request.prototype.perform = function (overrideOptions) {
      ...
      return XhrRequest_1.default.ajax(this.requestMethod, this.uri, options, this.headers).then(Request.handleSuccess.bind(this)).catch(Request.handleError.bind(this));
    };
...
function (module, exports, __webpack_require__) {
  ...
  var XhrRequest = function () {
    function XhrRequest() {} // Method that performs the ajax request
...
var client = new ApiAi.ApiAiClient({
  accessToken: c4202a73a8b147aea7f5fc95546f0cfe
});
var promise = client.textRequest('こんにちわ');
